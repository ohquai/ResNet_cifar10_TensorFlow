...
class Train(object):
    ...
    def build_train_validation_graph(self):
        ...
        labels = tf.cast(self.label_placeholder, tf.int64)
    ...
    def train(self):
        ...
        for step in range(FLAGS.train_steps):
            ...
            print('Train losses = ', train_loss_value)
    ...
    def train_operation(self, global_step, total_loss, top1_error):
        ...
        # optimizer = tf.train.MomentumOptimizer(learning_rate=self.lr_placeholder, momentum=0.9)
